...
namespace PTV.Developer.Clients.geocoding.Api
{
    ...
    public partial class LocationsApi : ILocationsApi
    {
        ...
        {
            PTV.Developer.Clients.geocoding.Client.ApiResponse<LocationsSearchResult> localVarResponse = SearchLocationsByAddressWithHttpInfo(country, state, locality, postalCode, street, houseNumber, countryFilter, language);
            return localVarResponse.Data;
        }
        ...
        {
            PTV.Developer.Clients.geocoding.Client.ApiResponse<LocationsSearchResult> localVarResponse = await SearchLocationsByAddressWithHttpInfoAsync(country, state, locality, postalCode, street, houseNumber, countryFilter, language, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            PTV.Developer.Clients.geocoding.Client.ApiResponse<LocationsSearchResult> localVarResponse = SearchLocationsByTextWithHttpInfo(searchText, countryFilter, language);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LocationsSearchResult</returns>
        public PTV.Developer.Clients.geocoding.Client.ApiResponse<LocationsSearchResult> SearchLocationsByTextWithHttpInfo(string searchText, List<string>? countryFilter = default(List<string>?), string? language = default(string?), int operationIndex = 0)
        {
        ...
        {
            PTV.Developer.Clients.geocoding.Client.ApiResponse<LocationsSearchResult> localVarResponse = await SearchLocationsByTextWithHttpInfoAsync(searchText, countryFilter, language, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
