...
namespace PTV.Developer.Clients.geocoding.Api
{
    ...
    public interface ILocationsApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// Gets suggestions for the input of the searchLocationsByText endpoint.
        /// </remarks>
        /// <exception cref="PTV.Developer.Clients.geocoding.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        SuggestionsByTextResponse GetSuggestionsByText(string searchText, int operationIndex = 0);
        ...
        ApiResponse<SuggestionsByTextResponse> GetSuggestionsByTextWithHttpInfo(string searchText, int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public interface ILocationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SuggestionsByTextResponse> GetSuggestionsByTextAsync(string searchText, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SuggestionsByTextResponse>> GetSuggestionsByTextWithHttpInfoAsync(string searchText, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class LocationsApi : ILocationsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SuggestionsByTextResponse</returns>
        public SuggestionsByTextResponse GetSuggestionsByText(string searchText, int operationIndex = 0)
        {
            PTV.Developer.Clients.geocoding.Client.ApiResponse<SuggestionsByTextResponse> localVarResponse = GetSuggestionsByTextWithHttpInfo(searchText);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SuggestionsByTextResponse</returns>
        public PTV.Developer.Clients.geocoding.Client.ApiResponse<SuggestionsByTextResponse> GetSuggestionsByTextWithHttpInfo(string searchText, int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SuggestionsByTextResponse</returns>
        public async System.Threading.Tasks.Task<SuggestionsByTextResponse> GetSuggestionsByTextAsync(string searchText, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            PTV.Developer.Clients.geocoding.Client.ApiResponse<SuggestionsByTextResponse> localVarResponse = await GetSuggestionsByTextWithHttpInfoAsync(searchText, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SuggestionsByTextResponse)</returns>
        public async System.Threading.Tasks.Task<PTV.Developer.Clients.geocoding.Client.ApiResponse<SuggestionsByTextResponse>> GetSuggestionsByTextWithHttpInfoAsync(string searchText, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'searchText' is set
            if (searchText == null)
            {
