...
public class SuggestionsByTextResponse {
  ...
  public SuggestionsByTextResponse suggestions(@javax.annotation.Nonnull List<Suggestion> suggestions) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SUGGESTIONS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSuggestions(@javax.annotation.Nonnull List<Suggestion> suggestions) {
    this.suggestions = suggestions;
  }


  public SuggestionsByTextResponse warnings(@javax.annotation.Nullable List<Warning> warnings) {
