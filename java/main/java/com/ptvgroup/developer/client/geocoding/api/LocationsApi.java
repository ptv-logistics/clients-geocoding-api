...
public class LocationsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public SuggestionsByTextResponse getSuggestionsByText(String searchText) throws ApiException {
    ApiResponse<SuggestionsByTextResponse> localVarResponse = getSuggestionsByTextWithHttpInfo(searchText);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<SuggestionsByTextResponse> getSuggestionsByTextWithHttpInfo(String searchText) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getSuggestionsByTextRequestBuilder(searchText);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getSuggestionsByTextRequestBuilder(String searchText) throws ApiException {
