...
public class LocationsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public SuggestionsByTextResponse getSuggestionsByText(String searchText, List<String> countryFilter) throws ApiException {
    ApiResponse<SuggestionsByTextResponse> localVarResponse = getSuggestionsByTextWithHttpInfo(searchText, countryFilter);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<SuggestionsByTextResponse> getSuggestionsByTextWithHttpInfo(String searchText, List<String> countryFilter) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getSuggestionsByTextRequestBuilder(searchText, countryFilter);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getSuggestionsByTextRequestBuilder(String searchText, List<String> countryFilter) throws ApiException {
